...
import { MdAutoAwesome, MdCheck, MdClose, MdTrendingUp, MdPeople, MdAccessTime } from "react-icons/md";
import { useLanguage } from "@/i18n";
import { ROLE_COLORS, DAY_ROLES, UserMin } from "./constants";
...
export default function AutoFillPreview({ tables, allUsers, submitting, onApply, onCancel, onEditAssignment }: AutoFillPreviewProps) {
