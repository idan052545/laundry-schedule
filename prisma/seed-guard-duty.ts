...
const USERS: Record<string, string> = {
  ...
  "אוהד": "ac6f3f3a-e6a4-4af5-936a-f60c7e15ac77", // alias for אוהד אבדי
  "נטע": "5167b8a7-b578-4776-aff7-f99cb89a2171", // alias for נטע וילונסקי
  "כפיר": "d88df087-2ef9-402e-ac28-208e004806a5", // alias for כפיר ברמן
};
...
async function main() {
  ...
  const guardData: GA[] = [
    ...
    { slot: "09:00-12:00", role: "תצפיתן", name: "עידן טורקיה" },
    { slot: "09:00-12:00", role: "עתודה", name: "יניב גופמן" },
    { slot: "09:00-12:00", role: "עתודה", name: "יהלי כוכבא" },
    ...
    { slot: "16:00-20:00", role: "עתודה", name: "עידן סימנטוב" },
    ...
    { slot: "20:00-00:00", role: "שג רכוב קדמי", name: "אוהד אבדי" },
    ...
    { slot: "00:00-04:00", role: "נשקייה", name: "אלון זלנפרוינד" },
    { slot: "00:00-04:00", role: "תצפיתן", name: "דולב כהן" },
    ...
    { slot: "04:00-08:00", role: "שג רכוב אחורי", name: "עידן סימנטוב", note: "04:00-08:00" },
    { slot: "04:00-08:00", role: "שג רכוב אחורי", name: "יניב גופמן", note: "04:00-05:00" },
    { slot: "04:00-08:00", role: "שג רגלי", name: "כפיר ברמן", note: "07:00-08:00" },
  ...
  const obsData: [string, string, string, string][] = [
    ...
    ["7", "אלון זלנפרוינד", "יהונתן אבוקרט", "מעיין מרדכי"],
    ["8", "אורי חדד", "נועה בלפור", "דור קיפגן"],
    ["9", "מיקה חיים", "יעל שושן", "רועי דדון"],
    ["10", "מאי אילארי", "נטע וילונסקי", "כרמל מורן"],
    ["11", "רוני מאירסון", "יהלי כוכבא", "הגרה שווגר"],
    ["12", "הודיה יעקבי", "אלון זלנפרוינד", "דנה פרידמן"],
