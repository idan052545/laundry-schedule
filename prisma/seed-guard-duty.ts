...
async function main() {
  ...
  const guardData: GA[] = [
    ...
    { slot: "12:00-16:00", role: 'כ"כב', name: "תמר נגר" },
    ...
    // 00:00-04:00
    { slot: "00:00-04:00", role: "שג רכוב קדמי", name: "מיקה חיים" },
    ...
    { slot: "04:00-08:00", role: "שג רכוב אחורי", name: "אוהד אבדי", note: "04:00-05:00" },
    { slot: "04:00-08:00", role: "שג רכוב אחורי", name: "כפיר ברמן" },
    ...
    { slot: "04:00-08:00", role: "תצפיתן", name: "רעות ניר" },
  ];
