...
async function main() {
  ...
  const guardData: [string, string, ...string[]][] = [
    ...
    ["12:00-16:00", 'כ"כב', "רותם כוכבי"],

    // 16:00-20:00
    ["16:00-20:00", "שג רכוב קדמי", "יזן כנעאן", "איתן אונגר"],
    ["16:00-20:00", "שג רכוב אחורי", "שני זידמן", "אלה בן גיא"],
    ["16:00-20:00", "שג רגלי", "רועי דדון"],
    ["16:00-20:00", "פטל", "פיונה פנג"],
    ["16:00-20:00", 'ימ"ח', "יערה רחוביצקי"],
    ["16:00-20:00", "בונקר", "נעם שילה"],
    ...
    // 00:00-04:00
    ["00:00-04:00", "שג רכוב קדמי", "מעיין מרדכי", "נועה בלפור"],
    ["00:00-04:00", "שג רכוב אחורי", "מיקה חיים", "שיר סויסה"],
    ["00:00-04:00", "פטל", "עדן בחרוף"],
    ["00:00-04:00", 'ימ"ח', "לייה אלון"],
    ["00:00-04:00", "בונקר", "יהלי כוכבא"],
    ["00:00-04:00", "נשקייה", "אלון"],
    ["00:00-04:00", "תצפיתן", "אוהד אבדי"],
    ...
    ["04:00-08:00", "שג רכוב אחורי", "דנה פרידמן", "ורוורה טופן"],
    ["04:00-08:00", "שג רגלי", "עמנואל נמרודי"],
    ["04:00-08:00", "פטל", "יהלי לוי"],
    ["04:00-08:00", 'ימ"ח', "טליה פרסט"],
    ["04:00-08:00", "בונקר", "עילי גולדשטיין"],
    ["04:00-08:00", "נשקייה", "עדי ויינשטיין"],
    ["04:00-08:00", "תצפיתן", "מאי אילארי"],
